...
import { postNewEntry } from '../../services/axios';
import { sendErrorAlert, sendConfirmAlert, sendSuccessAlert } from '../../utils/externalLibs/sweetAlertUtils';
...
async function ValidateAndSendEntryValues(
    event,
    newEntry,
    userData,
    setUserData,
